object PaintForm: TPaintForm
  ...
  object OpenButton: TAdvGlowButton
    Left = 176
    Top = 8
    Width = 65
    Height = 26
  ...
  object ToolsButton: TAdvGlowButton
    Left = 8
    Top = 274
    Width = 65
    Height = 25
  ...
  object PanelResolution: TPanel
    ...
    Height = 30
    BevelOuter = bvNone
    Caption = 'PanelResolution'
    Color = 5584425
    ParentBackground = False
    ShowCaption = False
    TabOrder = 3
    object AdvEditResolutionLbl: TAdvGlassButton
    ...
    object AdvEditResolution: TCurvyEdit
      Left = 135
      Top = 0
      Width = 125
      Height = 30
  ...
  object ScrollBox: TAdvScrollBox
    Left = 159
    Top = 93
    Width = 515
    Height = 367
  ...
  object ToolsPanel: TPanel
    ...
    ShowCaption = False
    TabOrder = 7
    object ColorGradientBar: TIEGradientBar
      Left = 0
      Top = 0
      Width = 257
      Height = 18
    ...
    object AdvComboBoxTools: TCurvyCombo
      Left = 54
      Top = 24
      Width = 82
      Height = 28
      ...
      Text = ''
      OnChange = AdvComboBoxToolsChange
    end
    object PanelWidth: TPanel
      ...
      ShowCaption = False
      TabOrder = 2
      object AdvEditWidthLbl: TAdvGlassButton
        AlignWithMargins = True
        Left = 2
        Top = 1
        Width = 42
      ...
      object AdvEditWidth: TCurvyEdit
        Left = 52
        Top = 1
        Width = 47
        Height = 24
    ...
    object AdvComboBoxToolsLbl: TAdvGlassButton
      AlignWithMargins = True
      Left = 2
      Top = 24
      Width = 42
  ...
  object OpenPictureDialog: TOpenPictureDialog
    Filter = 
      'All (*.png;*.jpg;*.jpeg;*.bmp;*.jpg;*.jpeg;*.png)|*.tee;*.gif;*.' +
      'png;*.jpg;*.jpeg;*.bmp;*.jpg;*.jpeg;*.png;|Portable Network Grap' +
      'hics (*.png)|*.png|JPEG Image File (*.jpg)|*.jpg|JPEG Image File' +
      ' (*.jpeg)|*.jpeg|Bitmaps (*.bmp)|*.bmp|JPEG Images (*.jpg)|*.jpg' +
