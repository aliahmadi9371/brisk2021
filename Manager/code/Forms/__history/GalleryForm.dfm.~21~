object GalleyForm: TGalleyForm
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object PanelSubGallery: TAdvPanel
    Left = 91
    Top = 42
    Width = 696
    Height = 504
    ...
    Text = ''
    FullHeight = 200
    object PanelLabelGallery: TPanel
      Left = 0
      Top = 0
      Width = 696
      Height = 31
    ...
    object AdvScrollBox: TAdvScrollBox
      ...
      ShowHint = False
      TabOrder = 2
      OnMouseWheelDown = AdvScrollBoxMouseWheelDown
      OnMouseWheelUp = AdvScrollBoxMouseWheelUp
      object Memo: TMemo
        Left = 280
        Top = 0
        Width = 416
    ...
    object SaveInfoPanel: TPanel
      ...
      object RangePanel: TPanel
        ...
        ShowCaption = False
        TabOrder = 0
        object RangeAdvEditLbl: TAdvGlassButton
          AlignWithMargins = True
          Left = 5
          Top = 0
          Width = 86
      ...
      object ScalePanel: TPanel
        ...
        object IndexAdvEdit: TCurvyEdit
          Left = 99
          Top = 0
          Width = 102
          Height = 30
  ...
  object OpenTextFileDialog: TOpenTextFileDialog
    Filter = 'Brisk Text Files|*_images.txt| Brisk Int Files|*.int'
    InitialDir = '.'
    Left = 192
    Top = 80
  end
